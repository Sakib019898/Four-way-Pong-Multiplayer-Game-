...
public class pong extends Applet implements Runnable,KeyListener,ActionListener{
    ...
    public void paint(Graphics g){
     ...
     if(step==3){
      ...
      g.drawString("You lost !!! "+pl.score,50,50);
      g.drawString("You are in the "+deadPosition+" th position ",50,150);
      ...
      g.fillRect(0,0,WIDTH,HEIGHT);
       ...
       bl.draw(g);
        ...
        if(noOfplayer==0){
           ...
           g.drawString("Cyan Board",720,50);
           g.drawString("Move:up down",720,70);
           g.drawString("Score :"+p2.score,720,90);
        }
        else if(noOfplayer==2){
        g.drawString("Megenta Board",720,50);
        ...
        int bx=140;
        for(int k=0;k<4;k++){
           if(AllPlayers[k][0].equals("0")){
             g.drawString(AllPlayers[k][1],720,bx);
             bx+=20;
           }
        }
        ...
        int cx=250;
        for(int k=0;k<4;k++){
           if(AllPlayers[k][0].equals("1")){
             g.drawString(AllPlayers[k][1],720,cx);
             cx+=20;
           }
        }
